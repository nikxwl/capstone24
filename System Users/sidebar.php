...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <a href="<?= $home ?>" class="brand-link">
    ...
    <br>
    <span class="text-sm ml-5 font-weight-light mt-2">&nbsp;&nbsp;83JP+F52, National Hi-way,</span> <br>
    <span class="text-sm ml-5 font-weight-light mt-2">&nbsp;&nbsp;Sto. Niño,, Biñan, Laguna</span>
  </a>
