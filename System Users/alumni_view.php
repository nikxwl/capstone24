      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Alumni info</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">You are currently viewing the alumni information</h3>
          ...
          <div class="card-body">
            <div class="row p-2">
              ...
              <div class="col-lg-9 col-md-6 col-12">
                <div class="row">
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      <small class="text-muted"><b>Year Graduatead:</b></small>
                      <h6><?php echo $row['year_graduated']; ?></h6>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
                      <small class="text-muted"><b>Current Job:</b></small>
                      <h6><?php echo $row['current_job']; ?></h6>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="form-group">
            ...
            <div class="row p-2">
              <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                <a class="h5 text-primary"><b>Alumni address</b></a>
                <div class="dropdown-divider"></div>
              </div>
              <div class="col-lg-12 col-md-6 col-12">
                <div class="row">
          ...
          <div class="card-footer">
            <a href="alumni.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Back</a>
            <a href="alumni_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-info float-right"><i class="fas fa-pencil-alt"></i> Edit</a>
          </div>
        </div>
      </div>
    </div>
