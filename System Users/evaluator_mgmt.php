<title>AGTGT | Manage Evaluator</title>
<?php 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Evaluator Add</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <form action="process_save.php" method="POST" enctype="multipart/form-data">
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
              <a href="evaluator.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="create_evaluator" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
            <li class="breadcrumb-item active">Evaluator Update</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Evaluator's photo</b></span>
                    <div class="input-group">
            ...
            <div class="card-footer">
              <a href="evaluator.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="update_evaluator" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
