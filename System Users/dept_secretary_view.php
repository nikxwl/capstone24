<title>AGTGT | Department Secretary info</title>
<?php 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Department Secretary info</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">You are currently viewing the Department Secretary information</h3>
          ...
          <div class="card-body">
            ...
            <div class="row p-2">
              <div class="col-lg-12 mt-3 mb-2 col-md-12 col-sm-12 col-12">
                <a class="h5 text-primary"><b>Department Secretary address</b></a>
                <div class="dropdown-divider"></div>
              </div>
              <div class="col-lg-12 col-md-6 col-12">
                <div class="row">
          ...
          <div class="card-footer">
            <a href="dept_secretary.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Back</a>
            <a href="dept_secretary_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-info float-right"><i class="fas fa-pencil-alt"></i> Edit</a>
          </div>
        </div>
      </div>
    </div>
