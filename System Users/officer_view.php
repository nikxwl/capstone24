<title>AGTGT | Alumni officer info</title>
<?php 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Alumni officer info</li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">You are currently viewing the alumni officer information</h3>
          ...
          <div class="card-footer">
            <a href="officer.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Back</a>
            <a href="officer_mgmt.php?page=<?php echo $row['user_Id']; ?>" class="btn btn-info float-right"><i class="fas fa-pencil-alt"></i> Edit</a>
          </div>
        </div>
      </div>
    </div>
