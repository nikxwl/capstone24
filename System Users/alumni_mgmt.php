<title>AGTGT | Manage Alumni</title>
<?php 
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Alumni Add</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg- col-md-2 col-sm-6 col-12">
                    <div class="form-group">
                        <span class="text-dark"><b>Year graduated</b></span>
                        <input type="number" class="form-control" placeholder="2000" name="year_graduated" id="year_graduated" pattern="\d{4}" minlength="4" maxlength="4" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 4)" required>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 col-sm-6 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Current work/job</b></span>
            ...
            <div class="card-footer">
              <a href="alumni.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="create_alumni" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-md-12">
        <form action="process_update.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 col-12">
                  <div class="form-group">
                    <span class="text-dark"><b>Current work/job</b></span>
                    <input type="text" class="form-control"  placeholder="Current work/job" name="current_job" value="<?php echo $row['current_job']; ?>" required>
                  </div>
                </div>
            ...
            <div class="card-footer">
              <a href="alumni.php" class="btn btn-secondary"><i class="fa-solid fa-backward"></i> Cancel</a>
              <button type="submit" class="btn btn-primary float-right" name="update_alumni" id="submit_button"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
            </div>
          </div>
        </form>
      </div>
