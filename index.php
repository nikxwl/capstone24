          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  ...
                  Exporting temporary brilliance, yet facing challenges with grace. Those who have labored, whom we were, in difficulties of which some were bad, others were good, we were those who shone. We fled difficulty; we loved blame.
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Not unless someone exports, diligently working with a magnanimous spirit. What great things are there, of which none are whom we would love to serve, for the least time we were working, and we were the leaders who were former and who we are now, and we were former who we would be the leaders of the future.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  I fled from things which were, navigating through challenges with resilience. Painful pain, pain without blame, many fled from minimal export, and minimal pain, minimal suffering. Truly, they who come after us, who we will give them light, and we who were once the leaders, and we were the ones who gave light.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Who among them should I read, navigating the intricacies of entrepreneurship. Formerly, they were, a difficult situation, a temporary escape, we are not, we are not to blame, we are not to blame, we are a fleeting light, a reading that wants to be, a fault before us unless there's something specific.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
              </div>
            </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6">
            <form action="processes.php" method="post" role="form" class="info-box p-3">
              <div class="row">
              ...
              <div class="my-3 bg-info">
                <h6 class="alert" role="alert"><?php echo $_SESSION['success']; ?></h6>
              </div>
              <?php unset($_SESSION['success']); } ?>
              <div class="text-center"><button type="submit" class="btn btn-primary btn-sm" name="send_email">Send Message</button></div>
            </form>
          </div>
